...
%global commit     afbce8bb46798518998f517cbacdbd65d4531a3f
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global commit_date 20230220
...
Source0:       https://git.savannah.gnu.org/cgit/emacs.git/snapshot/%{name}-%{commit}.tar.gz
